...
export function getDeviceIconSvg(uaStr: string = '', parsedUA: ParsedUA | null = null): string {
  ...
  const SVG_PHONE = `<svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.625 0.887695C11.412 0.887695 12.0498 1.52549 12.0498 2.3125V13.6875C12.0498 14.4745 11.412 15.1123 10.625 15.1123H5.375C4.58799 15.1123 3.9502 14.4745 3.9502 13.6875V2.3125C3.9502 1.52549 4.58799 0.887695 5.375 0.887695H10.625ZM5.375 1.9873C5.19551 1.9873 5.0498 2.13301 5.0498 2.3125V13.6875C5.0498 13.867 5.19551 14.0127 5.375 14.0127H10.625C10.8045 14.0127 10.9502 13.867 10.9502 13.6875V2.3125C10.9502 2.13301 10.8045 1.9873 10.625 1.9873H9.84668C9.79474 2.23666 9.57772 2.4248 9.3125 2.4248H6.6875C6.42228 2.4248 6.20526 2.23666 6.15332 1.9873H5.375Z" fill="currentColor"></path></svg>`;
...
export function countryFull(code: string | null | undefined): string | null {
  const c = String(code || '')
    ...
    .toUpperCase();
  if (!c) return null;
  if (typeof Intl === 'undefined' || !Intl.DisplayNames) return c;
  try {
