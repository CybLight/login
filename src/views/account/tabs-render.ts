      ...
      <div id="blockedUsersModal" class="account-notice-modal" style="display: none;">
        ...
        <div class="account-notice-card" role="dialog" aria-modal="true" style="width: min(92vw, 560px); max-height: 85vh; display: flex; flex-direction: column; padding: 20px; border-radius: 16px; position: relative; z-index: 2;">
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px; padding-bottom: 12px; border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
            <div style="font-size: 17px; font-weight: 700; color: #f87171; display: flex; align-items: center; gap: 10px;">
              <span>🚫</span>
              <span>${t('Заблокированные пользователи')}</span>
              <span id="stgBlockedUsersModalBadge" style="font-size: 12px; font-weight: 700; background: rgba(239, 68, 68, 0.2); color: #f87171; border: 1px solid rgba(239, 68, 68, 0.3); padding: 2px 8px; border-radius: 12px;">0</span>
            </div>
          ...
          <div id="stgBlockedUsersList" class="stg-blocked-users-list" style="overflow-y: auto; max-height: 55vh; padding-right: 4px;">
            <div style="font-size: 13px; color: #9ca3af; text-align: center; padding: 20px 0;">${t('Загрузка списка...')}</div>
          </div>
        </div>
      </div>
    ...
    <div class="sec-list">
      ...
      <div class="sec-panel is-hidden" id="secBackupPanel">
        <div class="sec-panel-inner sec-backup-panel">
          ...
          <div class="sec-form-block sec-form-block--qr" id="secQrSyncBlock">
          ...
          <div class="sec-form-block sec-form-block--drive" id="secDriveBlock">
            <div class="sec-form-block-head">
            ...
            <div class="sec-drive-info-card is-hidden" id="secDriveInfoCard">
              <div class="sec-drive-account-header">
                <div class="sec-drive-account-avatar" aria-hidden="true">
                ...
                <div class="sec-drive-account-details">
                  <span class="sec-drive-account-name" id="secDriveAccountName">${t('Вход выполнен')}</span>
                  <span class="sec-drive-account-email" id="secDriveAccountEmail">—</span>
                </div>
                <span class="sec-drive-badge">${t('Подключено')}</span>
              </div>

              <div class="sec-drive-grid">
            ...
            <div class="sec-actions sec-mt-12 sec-drive-actions">
              <div class="sec-actions-row">
                <button class="btn btn-primary" id="secDriveBackupSignInBtn" type="button">
                  ...
                  <span>${t('Войти через Google')}</span>
                </button>
                <button class="btn btn-primary is-hidden" id="secDriveBackupUploadBtn" type="button" hidden style="display: none;">
                  ...
                  <span>${t('Сохранить в Google Drive')}</span>
                </button>
                <button class="btn btn-success-outline is-hidden" id="secDriveBackupRestoreBtn" type="button" hidden style="display: none;">
                  <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                    <polyline points="7 10 12 15 17 10"></polyline>
                    <line x1="12" y1="15" x2="12" y2="3"></line>
                  </svg>
                  <span>${t('Восстановить из Google Drive')}</span>
                </button>
              </div>
              <div class="sec-actions-row">
                <button class="btn btn-danger-outline is-hidden" id="secDriveBackupDeleteBtn" type="button" hidden style="display: none;">
                  <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                  ...
                  <span>${t('Удалить из Drive')}</span>
                </button>
                <button class="btn btn-muted-outline is-hidden" id="secDriveBackupDisconnectBtn" type="button" hidden style="display: none;">
                  <svg class="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
                    <polyline points="16 17 21 12 16 7"></polyline>
                    <line x1="21" y1="12" x2="9" y2="12"></line>
                  </svg>
                  <span>${t('Выйти из Google')}</span>
                </button>
              </div>
            </div>
          </div>

          <div class="sec-form-block sec-form-block--export" id="secExportBlock">
            <div class="sec-form-block-head">
              <span class="sec-form-block-icon" aria-hidden="true">📤</span>
          ...
          <div class="sec-form-block sec-form-block--import" id="secImportBlock">
            <div class="sec-form-block-head">
              <span class="sec-form-block-icon" aria-hidden="true">📥</span>
