        ...
        <div class="sec-panel-inner sec-backup-panel">
          ...
          <div class="sec-form-block sec-form-block--drive">
            ...
            <div class="sec-actions sec-mt-12 sec-actions--wrap">
              ...
              <button class="btn btn-primary is-hidden" id="secDriveBackupUploadBtn" type="button" hidden style="display: none;">${t('Сохранить в Google Drive')}</button>
              <button class="btn btn-outline is-hidden" id="secDriveBackupRestoreBtn" type="button" hidden style="display: none;">${t('Восстановить из Google Drive')}</button>
              <button class="btn btn-outline btn-danger-outline is-hidden" id="secDriveBackupDeleteBtn" type="button" hidden style="display: none;">${t('Удалить из Drive')}</button>
              <button class="btn btn-outline is-hidden" id="secDriveBackupDisconnectBtn" type="button" hidden style="display: none;">${t('Выйти из Google')}</button>
            </div>
          </div>
