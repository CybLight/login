        ...
        <div class="account-mobile-header__inner">
          ...
          <div class="account-header-actions">
            ...
            >
              ...
              <span class="account-lang-btn__label">русский</span>
            </button>
            <button
              type="button"
            ...
            <div class="account-lang-menu" id="accountLangMenu" hidden>
              <button type="button" class="is-active">🇷🇺 Русский</button>
            </div>
            ...
            <div class="account-user-menu" id="accountUserMenu" hidden>
              ...
              <button class="account-user-menu__edit" id="headerEditAccountBtn" type="button" aria-label="Изменить аккаунт">Изменить аккаунт</button>
              <button class="account-user-menu__logout" id="headerLogoutBtn" type="button" aria-label="Выйти">Выйти</button>
            </div>
          </div>
        </div>
      </header>
