      ...
      <div class="profile-hero__left">
        ...
        <div class="profile-hero__meta">
          <div class="profile-hero__title">
            ...
            ${emailVerified ? '<span class="verified-badge" title="Verified"><svg class="verified-icon" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#3b82f6"/><path d="M9 12l2 2 4-4" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></span>' : ''}
